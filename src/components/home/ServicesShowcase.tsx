            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="relative w-full h-full min-h-0 flex items-center justify-center">
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className={`relative w-full h-full flex items-center justify-center ${activeService.id === 'seo' ? 'min-h-0 scale-75 left-1/2 -translate-x-1/2' : 'min-h-[1000px] translate-y-1/3 left-[45%] -translate-x-1/2'}`}> 
                      <Image
