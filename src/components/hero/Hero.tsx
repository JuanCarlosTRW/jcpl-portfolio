...
export default function Hero() {
       return (
	       ...
	       <div
		       className="relative z-10 flex flex-col items-center max-w-[420px] w-full px-6 pt-28 pb-10 sm:max-w-[540px] sm:px-8 sm:pt-32"
	       >
		       {/* Eyebrow */}
		       ...
		       {/* Headline */}
		       <h1 className="text-4xl sm:text-5xl font-semibold leading-[0.95] tracking-[-0.02em] text-white mb-6 [text-shadow:0_2px_8px_rgba(6,13,31,0.14)] text-center">
			       Growth Systems Built
			       <br className="hidden md:block" />
			       to Book Qualified Calls.
		       </h1>
		       {/* Subhead */}
		       <p className="text-base sm:text-lg text-white/85 leading-relaxed mb-8 max-w-[36ch] text-center">
