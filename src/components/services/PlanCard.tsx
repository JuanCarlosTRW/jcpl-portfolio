    ...
    <Reveal delay={0.08 * index}>
      <div
        ...
        className={`
          ...
          focus-visible:ring-2 focus-visible:ring-sv-primary focus-visible:ring-offset-2 focus-visible:ring-offset-sv-base
          ${isActive
            ? "border-[rgba(37,99,235,0.4)] bg-sv-surface shadow-[0_0_60px_rgba(37,99,235,0.08)]"
            : isFeatured
              ? "border-[rgba(37,99,235,0.25)] bg-sv-surface hover:border-[rgba(37,99,235,0.4)]"
      ...
      >
        ...
        {isFeatured && (
          <div
            ...
            style={{
              background: "linear-gradient(90deg, transparent, rgba(37,99,235,0.5), rgba(37,99,235,0.3), transparent)",
            }}
            aria-hidden="true"
          />
        )}
        ...
        <div className="mb-5">
          ...
          <p className="text-sm text-sv-primary font-medium">{tier.tagline}</p>
        </div>

        {/* Outcome line */}
        <p className="text-sm text-sv-text-sub leading-relaxed mb-5">
          {tier.outcome}
        </p>

        {/* Best for */}
        <p className="text-xs text-sv-text-sub mb-5 flex items-center gap-1.5">
        ...
        <ul className="space-y-2 mb-6 flex-1" role="list">
          {tier.deliverables.map((d, j) => (
            <li key={j} className="flex items-start gap-2.5 text-sm text-sv-text-sub">
        ...
        <div className="flex items-center gap-3 p-3 rounded-lg bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] mb-5">
          <span className="text-xs font-semibold text-sv-primary bg-[rgba(37,99,235,0.08)] px-2.5 py-1 rounded-full border border-[rgba(37,99,235,0.15)] whitespace-nowrap">
            {tier.timeline}
          </span>
        ...
        <div>
          {isActive && (
            <p className="text-[10px] uppercase tracking-[0.15em] text-sv-primary mb-2 text-center">
