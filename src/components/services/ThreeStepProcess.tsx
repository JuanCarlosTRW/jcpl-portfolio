...
const steps: Step[] = [
  ...
  },
  {
    ...
    body: "Site, ads, tracking, booking flow, and AI qualification. All built, all connected, all live. You approve each component before it ships. Median time to first booked call: 11 days.",
