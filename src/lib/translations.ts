...
export const translations: Record<Locale, TranslationsShape> = {
  en: {
    nav: {
      ...
      results: "Results",
      about: "About",
      apply: "Apply for a Diagnostic Call",
    ...
    faq: {
      ...
      applyCta: "Apply for a Diagnostic Call →",
      items: faqEn,
    },
    spots: {
    ...
    finalCta: {
      button: "Apply for a Diagnostic Call",
    },
    footer: {
    ...
    homepage: {
      ...
      oneOperator: {
        ...
        p2: "I built Client Growth around the opposite model. I run a maximum of 3 active partnerships at a time. Every system built and optimized personally. No account manager between us.",
        ...
        tag1: "I run a maximum of 3 active partnerships at a time.",
