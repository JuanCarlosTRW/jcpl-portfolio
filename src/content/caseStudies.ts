...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    outcome: "$300/month budget. DFW market. Conversion tracking live.",
    metrics: [
      { label: "Ad budget", value: "$300/mo" },
  ...
  },
  {
    ...
    outcome: "Page 1 in under 60 days. Montreal market.",
    resultTag: "Page 1 SEO, <60 days",
    metrics: [
      { label: "SEO", value: "Page 1" },
